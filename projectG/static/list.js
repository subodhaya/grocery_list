document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('#allList').addEventListener('click', () => load_lists('allList'));
  ...
  function create_list() {
   ...
   function abs(handler) {
    ...
    //var grocdata =["carrot","mango"];
         

    autocomplete(document.getElementById("myInput"),abs);
    // Make the button on compose working
   // document.querySelector('#compose-form').addEventListener('submit', send_list);
   
  
    // Clear out composition fields
    
    //document.querySelector('#compose-ListName').value = '';
   // document.querySelector('#compose-items').value = '';
  }  
}
